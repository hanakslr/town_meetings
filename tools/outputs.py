...
class OrgMeetingDetailsOutputTool(StructuredOutputTool):
    name = "committee_meeting_times_summary"

    @classmethod
    def get_tool_definition(cls) -> ToolParam:
        return {
            "name": OrgMeetingDetailsOutputTool.name,
            "description": "Record a summary of when a municipal group or committee meets using well structured JSON.",
            "input_schema": {
                "type": "object",
                "properties": {
                    "schedule": {
